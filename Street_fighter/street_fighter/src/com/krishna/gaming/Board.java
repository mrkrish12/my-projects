...
import com.krishna.gaming.sprites.Camera;
...
//			repaint();
   ...
   private void printBackgroundImage(Graphics pen) {
	   pen.drawImage(camera.defaultImage(),0,0,1500,900,null);
   }
